...
const stats = [
  ...
  { emoji: '💰', label: 'Total invested', value: '€24,000', note: 'since 2019' },
  { emoji: '🏦', label: 'Current value', value: '€31,850', note: 'as of today' },
      ...
      <div className="mx-auto max-w-2xl px-6 py-12">
        ...
        <header className="mb-10">
          ...
          <p className="mt-2 text-sm text-[--color-muted-foreground]">
            Tracking compound annual growth across your pension contributions.
          </p>
        </header>
              ...
              <div key={i} className="flex items-center justify-between px-4 py-3">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-[--color-muted-foreground]">{m.date}</p>
                  </div>
                </div>
