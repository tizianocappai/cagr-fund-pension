...
import { BmcWidget } from './components/BmcWidget.tsx'

function App() {
  const [analyticsEnabled, setAnalyticsEnabled] = useState(
    () => {
      try { return localStorage.getItem('gennaro_cookie_consent') === 'accepted' } catch { return false }
    }
  )
